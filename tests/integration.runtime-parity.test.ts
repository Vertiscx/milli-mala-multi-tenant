...
const TENANT_ENV: Record<string, string> = {
  ...
  TRYGGINGASTOFNUN_TICKET_UPDATE_WEBHOOK_SECRET: 'trygg-ticket-update-webhook-secret-01',
  TRYGGINGASTOFNUN_ZENDESK_OAUTH_CLIENT_ID: 'trygg-oauth-client-id-0123456789ab',
  TRYGGINGASTOFNUN_ZENDESK_OAUTH_CLIENT_SECRET: 'trygg-oauth-client-secret-0123456789',
